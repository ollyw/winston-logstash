...
Logstash.prototype.reconnectInterval = function () {
  ...
  if ( this.fibonacci_backoff ) {
      // Cap the factor at fib 18, or 4181, to stop later retries from being too infrequent. This is around ~7 minutes
      // with the 100ms retryInterval.
      var factor = Math.min(this.retries, 18);
      return fib(factor) * this.retryInterval;
  }
